...
public class GuestbookEntryAssetRenderer extends BaseJSPAssetRenderer<GuestbookEntry> {
    ...
    {
        try {
            return _guestbookEntryModelResourcePermission.contains(permissionChecker, _entry, ActionKeys.VIEW);
        }
        catch (Exception e) {
        }
    ...
    public String getJspPath(HttpServletRequest request, String template) {
        ...
        if (template.equals(TEMPLATE_FULL_CONTENT)) {
            ...
            return "/META-INF/resources/asset/entry/" + template + ".jsp";
        } else {
            return null;
        }
    }
    ...
    public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest, LiferayPortletResponse liferayPortletResponse) throws Exception {
        PortletURL portletURL = liferayPortletResponse.createLiferayPortletURL(
                getControlPanelPlid(liferayPortletRequest), GuestbookPortletKeys.GUESTBOOK, PortletRequest.RENDER_PHASE);
